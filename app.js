/* MTH1W Exam Simulator — Application Logic */

const ACCESS_CODE  = "MTH1W9000";
const EXAM_SECONDS = 7200;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "mth1w_exam_state_v1";
const SIM_Q_COUNT  = 300;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"number": "Number", "algebra": "Algebra", "data": "Data", "geometry_and_measurement": "Geometry and Measurement", "financial_literacy": "Financial Literacy"};  // maps domain key -> human-readable label for display
